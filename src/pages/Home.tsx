      ...
      <section className="relative h-[70vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto px-4">
          <h1 className="font-serif text-5xl md:text-7xl font-bold text-white mb-6 leading-tight">
            Your Journey, <span className="text-travel-cream">Your Way</span>
          </h1>
          <p className="text-xl md:text-2xl text-white/90 mb-8 max-w-2xl mx-auto leading-relaxed">
            Personalized travel experiences crafted entirely around you. From romantic getaways to family adventures.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link to="/contact">
              <TravelButton variant="cream" size="xl">
                Plan My Trip
              </TravelButton>
            </Link>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="font-serif text-4xl md:text-5xl font-bold text-foreground mb-6">
              Travel Tailored to <span className="text-primary">You</span>
            </h2>
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              At Anvaya Tours, we specialize in creating personalized travel experiences that revolve entirely around you. 
              Whether you're planning a romantic getaway, a family adventure, or a solo journey of self-discovery, 
              we tailor every itinerary to match your unique preferences.
            </p>
          </div>
